...
public class AssignmentAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("sign-username")).sendKeys("demosonam26909668889");
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector("input[id=loginusername]")).sendKeys("demosonam26909668889");
